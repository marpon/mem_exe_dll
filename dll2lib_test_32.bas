...
' compile with "PATH_TO_COMPILER" -x "libCalendrier_lib.a" -v -lib "dll2lib_test_32.bas" > "dll2lib_test_32.log" 2>&1
...
_:[CSED_COMPIL_NAME]:   libCalendrier_lib.a
...
sub init_calendrier()
	...
	__MACRO__INCLIGHT__(DLL32, "Calendrier.dll")

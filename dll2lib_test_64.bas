...
' compile with "PATH_TO_COMPILER" -x "libmy_dll64_lib.a" -v -lib "dll2lib_test_64.bas" > "dll2lib_test_64.log" 2>&1
...
_:[CSED_COMPIL_NAME]:   libmy_dll64_lib.a
...
sub init_my_dll64()
	...
	__MACRO__INCLIGHT__(DLL64, "my_dll64.dll")
